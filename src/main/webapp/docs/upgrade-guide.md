...
1. Logo 
  - `<a href="../pages/index.html" class="logo">` moved & rebuild to `.brand-link` inside `.main-sidebar`
2. Header / Nav
...
2. Logo / Brand Link
  - `<a href="../pages/index.html" class="brand-link"><img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text font-weight-light">AdminLTE 3</span></a>` replaces the old logo
3. Sidebar
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li class="active"><a href="../pages/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
  </ul>
</li>
```
  </div>
